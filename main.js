//semha yıldız karaderili yazdırdığım kısım
...
function yazdir() {
  if (index < metin.length) {
    // index değişkeninin numarası metin boyutundan küçük olduğu sürece
    titleElement1.textContent += metin.charAt(index); //o indexd olan karakteri textcontent e ekle
